...
namespace Server
{
    public static class Settings
    {
        ...
        {
            List<Clients> cls = new List<Clients>();
            Form1 formmain = (Form1)Application.OpenForms["MainForm"];
            if (formmain == null) return cls;

            formmain.Invoke((MethodInvoker)(() =>
            {
                foreach (ListViewItem itm in formmain.listView1.Items)
                    cls.Add((Clients)itm.Tag);
            }));
            return cls;
        }
    }
